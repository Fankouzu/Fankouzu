...
<svg width="${SVG_WIDTH}" height="${SVG_HEIGHT}" viewBox="0 0 ${SVG_WIDTH} ${SVG_HEIGHT}" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <g font-family="Segoe UI, Helvetica, Arial, sans-serif">
    <!-- 标题区域 -->
    <!-- OpenAI Logo -->
    <svg x="24" y="20" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="52" y="32" fill="url(#${titleGradientId})" font-size="20" font-weight="700" dominant-baseline="middle">OpenAI</text>
    <text x="126" y="32" fill="${colors.text}" font-size="20" font-weight="600" dominant-baseline="middle">Usage Stats</text>
