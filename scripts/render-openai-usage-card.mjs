...
<svg width="${SVG_WIDTH}" height="${SVG_HEIGHT}" viewBox="0 0 ${SVG_WIDTH} ${SVG_HEIGHT}" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <g font-family="Segoe UI, Helvetica, Arial, sans-serif">
    ...
    <text x="54" y="36" fill="url(#${titleGradientId})" font-size="20" font-weight="700">Usage Stats</text>
    <text x="54" y="54" fill="${colors.muted}" font-size="12">${escapeXml(subtitle)}</text>
